...
import { setCode, setName, clearForm, addSeatType } from "../../../controller/SliceReducer/seat";

const AddSeat = () => {
    const dispatch = useDispatch();
    const form = useSelector((state) => state.seat);
    const { name, code, loading, error, success } = form;
        ...
        <div>
            <div className="dark:bg-gray-900 bg-gray-100 flex justify-center items-center mt-10 mb-10">
                <div className="max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-md shadow-lg">
                    <h2 className="text-3xl font-semibold text-center mb-6 dark:text-white">Loại ghế</h2>
