...
import { deleteSpecialDay, setDateEnd, setDateStart, setEdit, setError, setId, setName, setSuccess, clearForm } from "../../../controller/SliceReducer/specialDay";
...
const Day = ({ data, pp }) => {
    ...
    const handleUpdate = (idd) => {
        if (isEdit && idd === id) {
            ...
            dispatch(setDateStart(data.start));
            dispatch(setDateEnd(data.end));
        }
