...
import { clearSearch, setSearchQuery } from "../../../controller/SliceReducer/search";
...
const AddSearch = () => {
    ...
    return (
        <div className="relative h-10 mx-auto rounded-full">
            <input onChange={handleInputChange} value={inputValue} className="rounded-full w-full  h-10 bg-transparent py-2 pr-6  pl-36 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200"></input>
            ...
            <button onClick={handleClear} className="absolute top-2 right-2.5">
