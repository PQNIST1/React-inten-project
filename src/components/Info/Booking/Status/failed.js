...
const FailedBooking = ({ item, onReturn }) => (
    <div className="w-full border-y-2 px-10 py-5 my-10 relative overflow-hidden rounded">
      ...
      <div className="flex">
        ...
        <button className="ml-32 m-auto" onClick={() => onReturn(item.booking.id)}>
          <img src="https://i.imgur.com/paNAzyF.png" alt="" className="h-20 w-20 " />
        </button>
      </div>
    </div>
  );
